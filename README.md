...
- Roadmaps, work breakdown, RAID / risk tracking  
- Agile (Scrum / Kanban), sprint planning, retrospectives  
- Backlog management and prioritisation  

**Technical**

- Python (for scripting, data exploration, and integration glue)  
- Git & GitHub (branches, pull requests, issues, project boards)  
- REST APIs, JSON, basic data pipelines / ETL  
...
- **Outcome‑driven:** I anchor AI work on clear business value (time saved, quality improved, revenue impact).  
- **Technical‑aware:** I’m not a full‑time engineer, but I can read code, understand architecture diagrams, and ask the right questions to unblock teams.  
- **Calm & structured:** I try to create predictable environments—clear priorities, known risks, and transparent communication.  
- **Collaborative:** I enjoy pairing with engineers, designers, and product managers to find pragmatic solutions.
